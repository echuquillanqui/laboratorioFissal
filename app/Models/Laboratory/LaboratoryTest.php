...
class LaboratoryTest extends Model
{
    ...
    protected $fillable = ['laboratory_area_id', 'codigo', 'nombre', 'descripcion', 'unidad_medida', 'tipo_dato', 'valor_minimo', 'valor_maximo', 'valor_alerta_minimo', 'valor_alerta_maximo', 'tiene_opciones', 'estado'];
