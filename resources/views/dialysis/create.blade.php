                ...
                <div class="form-section patient-prefill-section">
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <p>Estos datos llegan desde la opción “Generar diálisis” seleccionada en pacientes.</p>
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <label class="form-label">Sesión sugerida</label>
                            <input class="form-control" name="numero_sesion_sugerida" value="{{ (int) $patient['numero_sesion'] + 1 }}" readonly>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <label class="form-label">Edad / Sexo</label>
                            <input class="form-control" name="edad_sexo" value="{{ $patient['edad'] }} años · {{ $patient['sexo'] }}" readonly>
                        </div>
                        <div class="col-sm-6 col-md-3">
